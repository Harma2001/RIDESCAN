...
public class LiveParams extends AppCompatActivity {
    ...
    public class SendCmds extends Thread
    {
        ...
        public void run()
        {
            while (true)
            {
                ...
                try
                {
                    reader = new BufferedReader(new InputStreamReader(getApplicationContext().getAssets().open("absliveparameters2.csv")));
                    String mLine;
