...
import static com.example.tvsridescan.R.drawable.black_rec;
...
public class SignatureMainLayout extends LinearLayout implements OnClickListener {
    ...
    private LinearLayout buttonsLayout()
    {
       ...
       // Button clearBtn = new Button(this.getContext());
        Button doneBtn = new Button(this.getContext());
        ...
        saveBtn.setBackgroundResource(R.drawable.black_rec);
        ...
        clearBtn.setBackgroundResource(R.drawable.black_rec);
        clearBtn.setOnClickListener(this);
*/
        doneBtn.setText("Done");
        doneBtn.setTag("Done");
        doneBtn.setHeight(35);
        doneBtn.setTextColor(Color.WHITE);
        doneBtn.setBackgroundResource(R.drawable.black_rec);
        doneBtn.setOnClickListener(this);

        linearLayout.addView(saveBtn);
        //linearLayout.addView(clearBtn);
        linearLayout.addView(doneBtn);
