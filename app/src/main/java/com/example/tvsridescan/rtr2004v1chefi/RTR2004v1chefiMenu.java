package com.example.tvsridescan.rtr2004v1chefi;
...
public class RTR2004v1chefiMenu extends AppCompatActivity {
    ...
    MediaPlayer mp;
    Context context;
    private static final String TAG = "RTR2004v1chefiMenu.this";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rtr2004v1chefi_menu);
        init();
    }
    ...
    private void init()
    {
        context = RTR2004v1chefiMenu.this;
