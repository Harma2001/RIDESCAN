...
public class ABSRoutinecontrol extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_absroutinecontrol);
        context = ABSRoutinecontrol.this;
        ...
        toggleButton1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                {
                    cmddata = "3101B07132";  //start 5 SECONDS  //checked
                    WriteCmd writeCmd = new WriteCmd();
                    writeCmd.start();
                }
                else
                {
                    cmddata = "3102B071"; //stop //checked
                    WriteCmd writeCmd = new WriteCmd();
                    writeCmd.start();
                }
            }
